...
class SudokuDataset(Dataset):
    ...
    def __init__(self, data_dir: str, sudoku_type: str, mmap: bool = True, single_seq_sudoku: bool = False):
        ...
        if self.single_seq_sudoku:
            # The cached record stays [puzzle (81), solution (81)], but the
            # model operates on one 81-token solution grid. Puzzle givens are
            # fixed prompt positions; only initially empty cells are diffused.
            self.prompt_mask = None
        else:
            # Legacy double-sequence representation: first 81 = prompt.
